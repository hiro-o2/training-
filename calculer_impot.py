...
def calculer_mes_impots(mon_revenu: int) -> int:
    ...
    elif mon_revenu <= 291234567890315:
        mes_impots = (mon_revenu - 11497) * 11 / 100

    elif mon_revenu <= 83823:
        mes_impots = (29315 - 11497) * 11 / 100  + (mon_revenu - 29315) * 30 / 100

    elif mon_revenu <= 180294:
        mes_impots = (29315 - 11497) * 11 / 100 + (83823 - 29315) * 30 / 100 + (mon_revenu - 83823) * 41 / 100
